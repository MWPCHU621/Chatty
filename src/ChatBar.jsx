...
class ChatBar extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            name = "currentUser"
            onChange = { this.updateHandler } onKeyUp = { this.inputHandler } value = { currentUser }
            /> <
            input className = "chatbar-message"
            name = "message"
            onChange = { this.updateHandler } onKeyUp = { this.inputHandler } placeholder = "Type a message and hit ENTER"
            value = { message }
            /> <
            /footer>
        );
